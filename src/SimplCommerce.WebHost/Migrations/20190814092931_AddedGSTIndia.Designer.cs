...
namespace SimplCommerce.WebHost.Migrations
{
    ...
    [Migration("20190814092931_AddedGSTIndia")]
    partial class AddedGSTIndia
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimplCommerce.Module.Core.Models.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "Aftership.ApiKey",
                            IsVisibleInCommonSettingPage = false,
                            Module = "ShipmentTrackingAfterShip",
                            Value = ""
                        });
                });
            ...
            modelBuilder.Entity("SimplCommerce.Module.GSTIndia.Models.TaxClass", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SimplCommerce.Module.GSTIndia.Models.TaxRate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SimplCommerce.Module.Orders.Models.OrderItemTax", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SimplCommerce.Module.Catalog.Models.Product", b =>
                {
                    ...
                    b.HasOne("SimplCommerce.Module.GSTIndia.Models.TaxClass", "TaxClass")
                        .WithMany()
            ...
            modelBuilder.Entity("SimplCommerce.Module.Orders.Models.OrderItemTax", b =>
                {
                    b.HasOne("SimplCommerce.Module.Orders.Models.OrderItem")
                        .WithMany("Taxes")
