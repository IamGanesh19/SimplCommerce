...
{
    public class OrderChangedSendEmailHandler : INotificationHandler<OrderChanged>
    {
        private readonly IOrderEmailService _orderEmailService;
        private readonly IRepository<Order> _orderRepository;
        private readonly IRepository<User> _userRepository;

        public OrderChangedSendEmailHandler(IRepository<User> userRepository, IOrderEmailService orderEmailService, IRepository<Order> orderRepository)
        {
        ...
        public async Task Handle(OrderChanged notification, CancellationToken cancellationToken)
        {
            ...
            if(notification.NewStatus == OrderStatus.Shipped || notification.NewStatus == OrderStatus.Complete)
            { 
                ...
                var user = _userRepository
                    .Query()
                    .FirstOrDefault(x => x.Id == notification.Order.CustomerId);
